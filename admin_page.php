                  ...
                  <h3><?php echo $total_completed; ?>/-</h3>
                   ...
                   <div class="box">
                       <?php 
                          ...
                          $number_of_station = mysqli_num_rows($select_station);
                        ?>
                        <h3><?php echo $number_of_station; ?></h3>
                        <p><a href="admin_station_view.php">Stations</a></p>
                   </div>

                   <div class="box">
                       <?php 
                          $select_attendants = mysqli_query($conn, "SELECT * FROM `attendant`")or die('query failed');
                          $number_of_attendants = mysqli_num_rows($select_attendants);
                        ?>
                        <h3><?php echo $number_of_attendants; ?></h3>
                        <p><a href="admin_attendant_view.php">Station Attendants</a></p>
                   </div>
